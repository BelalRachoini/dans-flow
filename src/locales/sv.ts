export const sv = {
  ...
  lessonBooking: {
    ...
    single: '1 drop in-biljett',
    couple: '2 drop in-biljetter',
    trio: '3 drop in-biljetter',
  ...
  courses: {
    ...
    selectInstructors: 'Välj instruktörer',
    selectedInstructors: 'valda',
    primaryInstructor: 'Huvudinstruktör',
    selectPrimaryInstructor: 'Välj huvudinstruktör',
    noPrimary: 'Ingen huvudinstruktör',
    primaryInstructorHelp: 'Valfritt: Välj en huvudinstruktör bland de valda',
    ...
    pageEditor: {
      ...
      sectionTitle: 'Sektion rubrik (valfritt)',
      confirmDelete: 'Är du säker på att du vill ta bort denna sektion?',
      hero: 'Hero (omslagsbild)',
      text: 'Text',
      video: 'Video',
      image: 'Bild',
      gallery: 'Bildgalleri',
      faq: 'FAQ',
      booking: 'Anmälan',
      heroDescription: 'Hero-sektionen använder automatiskt kursens titel, bild, nivå, instruktör och datum.',
      ...
      answer: 'Svar',
      removeItem: 'Ta bort',
      addFaqItem: 'Lägg till FAQ-post',
      bookingDescription: 'Anmälningssektionen visar automatiskt kursens pris, klippkortsinformation, lektionsschema och anmälningsknapp.',
      titlePlaceholder: 'Ange sektion rubrik...',
  ...
  course: {
    ...
    pageEditor: {
      ...
      fontSize: 'Textstorlek',
      videoUrl: 'Video-URL',
      videoUrlHelp: 'Klistra in YouTube eller Vimeo URL, eller full embed-kod',
      videoUrlExtracted: 'Video URL extraherades från embed-kod',
      videoUrlInvalid: 'Ogiltigt video URL-format',
      aspectRatio: 'Bildförhållande',
      imageUrl: 'Bild-URL',
      altText: 'Alt-text',
      caption: 'Bildtext (valfritt)',
    ...
    beginner: 'Nybörjare',
    intermediate: 'Mellanivå',
    advanced: 'Avancerad',
    instructorTBA: 'Instruktör TBA',
    lessons: 'lektioner',
    enrollmentError: 'Kunde inte skapa anmälan',
    includesTickets: 'Inkluderar',
    tickets: 'klippkort',
    enrollNow: 'Anmäl dig nu',
    lessonSchedule: 'Lektionsschema',
  ...
  crm: {
    ...
    actions: {
      ...
      giveEventTicket: "Ge eventbiljett",
      selectEventDate: "Välj datum",
      allDates: "Alla datum",
      tieToCourse: "Koppla till kurs (valfritt)",
      genericCourse: "Generisk – valfri klass",
      createFreeBooking: "Skapa gratisbokning",
      generateCompCode: "Skapa rabattkod",
      compCodeCreated: "Kod {code} skapad – kopiera och dela",
      eventBookingCreated: "Gratisbokning för {event} skapad",
      attendees: "Deltagare",
      ticketTarget: "Mål",
      targetDropIn: "Drop-in / generisk",
      targetCourse: "Kurs (termin, nybörjare…)",
      targetEvent: "Event",
      selectCourse: "Välj kurs",
      selectEvent: "Välj event",
      currentClips: "Aktiva klippkort",
      currentEventBookings: "Aktiva eventbokningar",
      noClips: "Inga aktiva klipp",
      noEventBookings: "Inga aktiva eventbokningar",
      cancelBooking: "Avboka",
      bookingCancelled: "Bokning för {event} avbokad",
      confirmCancelBooking: "Avboka denna bokning? Platsen frigörs.",
      give: "Ge",
      remove: "Ta bort",
    },
