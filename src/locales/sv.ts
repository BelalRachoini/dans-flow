export const sv = {
  ...
  tickets: {
    ...
    purchaseTickets: 'Köp biljetter',
    viewTickets: 'Visa mina biljetter',
    ticketId: 'Biljett-ID',
    purchasedAt: 'Köpt',
    status: 'Status',
    course: 'Kurs',
    subtitle: 'Dina eventbiljetter',
    subtitleEmpty: 'Dina eventbiljetter',
    subtitleWithTickets: 'Dina kursbiljetter och incheckningar',
    noTicketsYet: 'Inga biljetter ännu',
    noTicketsDescription: 'Du har inga eventbiljetter. Köp en kurs eller biljett till våra kommande event för att komma igång!',
    buyCourses: 'Köp kurser',
    viewEvents: 'Se event',
    howItWorks: 'Så här fungerar det:',
    howItWorksDescription: 'Du kan checka in dig själv genom att klicka på "Checka in nu"-knappen, eller visa din QR-kod för instruktören att skanna. Klicka på "Visa QR i helskärm" för en större kod som är lättare att skanna.',
    searchPlaceholder: 'Sök kurs...',
    filterAll: 'Alla',
    filterValid: 'Giltiga',
    filterCheckedIn: 'Incheckade',
    filterCancelled: 'Avbrutna',
    noMatchingTickets: 'Inga biljetter matchar dina filter',
    statusValid: 'Giltig',
    statusCheckedIn: 'Incheckad',
    statusCancelled: 'Avbruten',
    statusRefunded: 'Återbetald',
    checkIns: 'Incheckningar',
    checkInNow: 'Checka in nu',
    checkingIn: 'Checkar in...',
    checkInSuccess: 'Incheckning lyckades!',
    checkInFailed: 'Incheckning misslyckades',
    checkInError: 'Ett fel uppstod',
    checkInErrorDescription: 'Kunde inte checka in. Försök igen.',
    showQRFullscreen: 'Visa QR i helskärm',
    qrCodeTitle: 'QR-kod för incheckning',
    showToInstructor: 'Visa denna kod för instruktören',
    qrGenerateError: 'Kunde inte generera QR-kod',
    eventBadge: 'Event',
    errorTitle: 'Fel',
    loadError: 'Kunde inte ladda biljetter',
  },
