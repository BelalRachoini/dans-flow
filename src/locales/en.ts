export const en = {
  ...
  crm: {
    ...
    actions: {
      ...
      giveEventTicket: "Give Event Ticket",
      selectEventDate: "Select Date",
      allDates: "All Dates",
      tieToCourse: "Tie to course (optional)",
      genericCourse: "Generic – any class",
      createFreeBooking: "Create Free Booking",
      generateCompCode: "Generate Comp Code",
      compCodeCreated: "Code {code} created – copy and share",
      eventBookingCreated: "Free booking for {event} created",
      attendees: "Attendees",
      ticketTarget: "Target",
      targetDropIn: "Drop-in / generic",
      targetCourse: "Course (semester, beginner…)",
      targetEvent: "Event",
      selectCourse: "Select course",
      selectEvent: "Select event",
      currentClips: "Current clip packages",
      currentEventBookings: "Active event bookings",
      noClips: "No active clips",
      noEventBookings: "No active event bookings",
      cancelBooking: "Cancel booking",
      bookingCancelled: "Booking for {event} cancelled",
      confirmCancelBooking: "Cancel this booking? The spot will be freed up.",
      give: "Give",
      remove: "Remove",
    },
